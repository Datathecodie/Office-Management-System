        ...
        <div class="container bg-inverse text-white">
          <h1>Welcome <?php echo $name."</h1>".$error; ?> 
            ...
            <div class="col-sm-9 bg-faded text-muted">
                <br />            
                <div class="title"> <h2>Search for Document/Folder</h2> </div>
                <form action="search1.php" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                      <label for="example-text-input">Search</label>
                      <input class="form-control" type="text" name="term" placeholder="Enter Search Terms" id="example-text-input">
                      </div>
               <div class="row container">  <div class=" col-md-6">    <fieldset class="form-group">
                        <div class="form-check">
                          <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="Radios" id="optionsRadios1" value="name" checked> 
                            Name
                          </label>
                        </div>
                        <div class="form-check">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="Radios" id="optionsRadios2" value="desc">
                            Category
                          </label>
                        </div>
                     </fieldset> </div>
                  ...
                  <div class="col-md-6">   <fieldset class="form-group">
                        <div class="form-check">
                          <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="Radios1" id="optionsRadios1" value="doc" checked> 
                            Document
                          </label>
                        </div>
                        <div class="form-check">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="Radios1" id="optionsRadios2" value="folder">
                            Folder
                          </label>
                        </div>
                      </fieldset> </div> </div>
