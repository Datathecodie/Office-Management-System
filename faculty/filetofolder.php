        ...
        <div class="container bg-inverse text-white">
          <h1>Welcome <?php echo $name; ?> </h1>
            ...
            <div class="col-sm-9 bg-faded text-muted">
                <br />            
                 <div class="title"> List of documents to add in Folder:</div>
                    ...
                    foreach ($result2 as $row)
                    {
                        echo "<tr>
                                <td> ".$row['id']."</td>
                                <td> ". $row['title']."</td>";
                                $validate = "SELECT * FROM foldercon where docname = '".$row['title']."' and fname  = '".$folder."'  ";
                                $result2 = mysqli_query($con,$validate);
                            if(mysqli_num_rows($result2) >0)
                                 echo  " <td> File added to the Folder. </td>";
                                else
                             echo  " <td> <a href = \"filetofolder2.php?doc=".$row['title']."&folder=".$folder." \"> Click to Add the File to folder. </a> </td> 
