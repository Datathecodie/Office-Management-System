        ...
        <div class="container bg-inverse text-white">
          <h1>Welcome <?php echo $name."</h1>".$error; ?> 
            ...
            <div class="col-sm-9 bg-faded text-muted">
                <br />            
                <div class="title"> <h2>Add a New Folder</h2> </div>
                <form action="newfolder2.php" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                      <label for="example-text-input">Folder Name</label>
                      <input class="form-control" type="text" name="name" placeholder="Enter Name" id="example-text-input">
                      </div>
                  <div class="form-group">
